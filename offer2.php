...
$stmt = $pdo->prepare("SELECT * FROM products WHERE LOWER(category) = LOWER('Offers2')");
$stmt->execute();
...
<div class="container mt-5">
    ...
    <?php if (empty($offerProducts)): ?>
        <p class='text-center text-danger'>No products found for 'Offers2'. Check database entries.</p>
    <?php else: ?>
        <div class="row">
