...
$stmt = $pdo->prepare("SELECT * FROM products WHERE LOWER(category) = LOWER('Offers1')");
$stmt->execute();
...
<div class="container mt-5">
    ...
    <?php if (empty($offerProducts)): ?>
        <p class='text-center text-danger'>No products found for 'Offers1'. Check database entries.</p>
    <?php else: ?>
        <div class="row">
